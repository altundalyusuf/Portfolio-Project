                ...
                <div className="navbar bg-secondary rounded">
                    ...
                    <div className="flex justify-end flex-1 px-2">
                        <div className="flex items-stretch">
                            {/* Create Post Button */}
                            <a href='create-post' className="btn btn-ghost btn-circle avatar tooltip tooltip-bottom md:me-3" data-tip="Gönderi oluştur">
                            ...
                            <div className="dropdown dropdown-end md:me-20 ">
                                {/* My Account Dropdown */}
                                <label tabIndex={0} className="btn btn-ghost btn-circle avatar tooltip tooltip-bottom" data-tip='Özelleştir'>
                                    <div className="w-full rounded-full">
                                        {user.photoURL ?
