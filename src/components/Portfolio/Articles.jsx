...
const Articles = () => {
    return (
        <>
            <div id='articles' className="bg-white py-24 sm:py-32">
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="mx-auto max-w-2xl lg:mx-0">
                        <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Gönderilerim</h2>
                        ...
                        {posts.map((post) => (
                            <article key={post.id} className="flex max-w-xl flex-col items-start justify-between">
                                <div className='w-32 md:w-full bg-slate-700 flex items-center justify-center '>
                                    <img src={post.image} className='w-full md:w-48 lg:w-full h-fit' alt="welcome-pic" />
                                </div>
